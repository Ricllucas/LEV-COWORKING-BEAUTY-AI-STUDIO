...
- Name: landing-page.spec.ts >> Landing Page >> should display professionals section
- Location: e2e\landing-page.spec.ts:16:3
...
Call log:
  - waiting for locator('text=Conheça nossas especialistas')
